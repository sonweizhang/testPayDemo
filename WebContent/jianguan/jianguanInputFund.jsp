...
function getTranData(){
	...
	"<orderNo>"+orderNo+"</orderNo><orderType>"+orderType+"</orderType>" +
	"<ebankFalg>"+ebankFalg+"</ebankFalg></Req>";
...
<body>
	<div align="center">
		...
		<form action="http://60.12.221.84:28080/pay/inputFund.do"
	...
	<div align="center" style="border: 1px solid gray; height: 320px;">
		<div align="right"
			...
			<table border="1px">
				...
				<tr>
					<td>orderType</td>
					<td><input id="orderType" name="orderType" type="text"
						value="0" /></td>
				</tr>
				<tr>
					<td>ebankFalg</td>
					<td><input id="ebankFalg" name="ebankFalg" type="text"
						value="1" /></td>
				</tr>
			</table>
		</div>
