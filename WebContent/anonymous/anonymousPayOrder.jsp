...
function getTranData(){
	...
	var MSMerchantIdB = $("#MSMerchantIdB").val();
	...
	"<curType>"+curType+"</curType><bankId>"+bankId+"</bankId><returnURL>"+returnURL+"</returnURL>" +
	"<notifyURL>"+notifyURL+"</notifyURL><remark>"+remark+"</remark><userId>"+userId+"</userId>" +
	...
	"<bankType>"+bankType+"</bankType><cardType>"+cardType+"</cardType><goodsName>"+goodsName+"</goodsName>" + 
	"<MSMerchantIdB>"+MSMerchantIdB+"</MSMerchantIdB><returnFlag>"+returnFlag+"</returnFlag>" + 
	"</B2CReq>";
	...
	<div align="center">
		...
		<form action="http://60.12.221.84:28080/pay/anonymousPayOrder.do"
			...
			<table>
				...
				<tr>
					<td>goodsName</td>
					<td><input id="goodsName" name="goodsName" type="text" title="支付宝微信显示用"
						value="填写商品名称" /></td>
				</tr>
			</table>
	...
	<div align="center" style="border: 1px solid gray; height: 620px;">
		<div align="right"
			...
			<table border="1px">
				...
				<!-- <tr>
					<td>merName</td>
					<td><input id="merName" name="merName" type="text"
						value="" /></td>
				</tr> -->
				<tr>
					<td>orderNo</td>
				...
				<tr>
					<td>goodsName</td>
					<td><input id="goodsName2" name="goodsName2" type="text" value="" /></td>
				</tr>
				<tr>
					<td>MSMerchantIdB</td>
					<td><input id="MSMerchantIdB" name="MSMerchantIdB" type="text" value="" title="有扫码二级商户号时才必输"/></td>
				</tr>
				<tr>
					<td>returnFlag</td>
					<td><input id="returnFlag" name="returnFlag" type="text" value="" title="0:返回页面,1:返回字符串"/></td>
				</tr>
			</table>
		</div>
		<div align="center"
