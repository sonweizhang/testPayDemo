...
function getTranData(){
	...
	var orderNo = $("#orderNo").val();//orderNo字段填写商户自己的订单编号
	var refundAmt = $("#refundAmt").val();
	var notifyURL = $("#notifyURL").val();
	var merRefundOrderFlowNo = $("#merRefundOrderFlowNo").val();//merRefundOrderFlowNo字段填写商户自己生成的退款流水号
	var result = "<?xml version=\"1.0\" encoding=\"GBK\" ?><B2CReq>" +
	"<merchantId>"+merchantId+"</merchantId><orderNo>"+orderNo+"</orderNo>" +
	"<refundAmt>"+refundAmt+"</refundAmt><notifyURL>"+notifyURL+"</notifyURL>" +
	"<merRefundOrderFlowNo>"+merRefundOrderFlowNo+"</merRefundOrderFlowNo>" +
	"</B2CReq>";
	...
	<div align="center" style="border: 1px solid gray; height: 320px;">
		<div align="right"
			...
			<table border="1px">
				...
				<tr>
					<td>merRefundOrderFlowNo</td>
					<td><input id="merRefundOrderFlowNo"
						name="merRefundOrderFlowNo" type="text" value="TK20160820test" /></td>
				</tr>
			</table>
		</div>
		<div align="center"
