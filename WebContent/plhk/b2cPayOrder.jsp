...
function getTranData(){
	...
	"<remark>"+remark+"</remark><userId>"+userId+"</userId><goodsType>"+goodsType+"</goodsType>" +
	"<isBind>"+isBind+"</isBind><mobile>"+mobile+"</mobile><certNo>"+certNo+"</certNo><userName>"+userName+"</userName>" +
	"<cardNo>"+cardNo+"</cardNo><bankType>"+bankType+"</bankType><cardType>"+cardType+"</cardType>" + 
	"</B2CReq>";
	...
	<div align="center">
		...
		<form action="http://60.12.221.84:28080/pay/preprocess.do"
			...
			<table>
				...
				<tr>
					<td>merSignMsg</td>
					<td><input id="merSignMsg" name="merSignMsg" type="text"
