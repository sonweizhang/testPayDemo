...
<title>2.1 汇款明细查询</title>
<script type="text/javascript">
function getTranData(){
	var beginDate = $("#beginDate").val();
	var merFlowNo = $("#merFlowNo").val();
	var result = "<?xml version=\"1.0\" encoding=\"GBK\" ?><B2CReq>" +
	"<beginDate>"+beginDate+"</beginDate><merFlowNo>"+merFlowNo+"</merFlowNo>" +
	"</B2CReq>";
...
<body>
	<div align="center">
		<!-- <form action="http://localhost:8080/pay/queryRemitDetail.do" -->
		<!-- <form action="http://pay.yoyipay.com/pay/getBanksForPay.do" -->
		<form action="http://60.12.221.84:28080/pay/queryRemitDetail.do"
		...
		<div align="right"
			...
			<table border="1px">
				<tr>
					...
					%>
					<td><input id="beginDate" name="beginDate" type="text"
						value="<%=dateStr %>" /></td>
				</tr>
				<tr>
					<td>merFlowNo</td>
					<td><input id="merFlowNo" name="merFlowNo" type="text"
						value="10177" /></td>
				</tr>
			</table>
		</div>
