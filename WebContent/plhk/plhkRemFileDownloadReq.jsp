...
function getTranData(){
	...
	"<version>"+version+"</version><tranTime>"+tranTime+"</tranTime>" +
	"<notifyURL>"+notifyURL+"</notifyURL><fileType>"+fileType+"</fileType>" +
	"</B2CReq>";
...
<body>
	<div align="center">
		...
		<form action="http://60.12.221.84:28080/pay/remFileDownloadReq.do"
	...
	<div align="center" style="border: 1px solid gray; height: 350px;">
		<div align="right"
			...
			<table border="1px">
				...
				<tr>
					<td>tranTime</td>
					<td><input id="tranTime" name="tranTime" type="text"
						value="20160825" /></td>
				</tr>
				<tr>
					<td>notifyURL</td>
					<td><input id="notifyURL" name="notifyURL" type="text"
						value="http://192.168.1.191:8088/testPayDemo/NotificationDemo" /></td>
				</tr>
				<tr>
					<td>fileType(选填)<br>支持csv、xls,默认xls
					</td>
					<td><input id="fileType" name="fileType" type="text"
						value="csv" /></td>
				</tr>
			</table>
		</div>
