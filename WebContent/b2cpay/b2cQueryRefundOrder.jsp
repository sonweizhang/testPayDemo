...
function getTranData(){
	...
	"<merchantId>"+merchantId+"</merchantId><tranSerialNo>"+tranSerialNo+"</tranSerialNo>" +
	"</B2CReq>";
...
<body>
	<div align="center">
		...
		<!-- <form action="http://localhost:8080/pay/QueryRefundOrder.do" -->
		<!-- <form action="http://60.12.221.84:28080/pay/QueryRefundOrder.do" -->
		<form action="https://pay.yoyipay.com/pay/QueryRefundOrder.do"
			...
			<table border="1px">
				...
				<tr>
					...
					<td><input id="tranSerialNo" name="tranSerialNo" type="text"
						value="refund20160805001" title="商户退款订单流水号merRefundOrderFlowNo"/></td>
				</tr>
			</table>
		</div>
		<div align="center"
