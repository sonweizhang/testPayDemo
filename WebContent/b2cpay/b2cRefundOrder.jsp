...
function getTranData(){
	...
	var merRefundOrderFlowNo = $("#merRefundOrderFlowNo").val();
...
<body>
	<div align="center">
		...
		<form action="https://pay.yoyipay.com/pay/refundOrder.do"
			...
			<table border="1px">
				...
				<tr>
					...
					<td><input id="orderNo" name="orderNo" type="text"
						value="testOrder20161112001" title="原订单号"/></td>
				</tr>
				<tr>
					<td>refundAmt</td>
				...
				<tr>
					...
					<td><input id="merRefundOrderFlowNo" name="merRefundOrderFlowNo" type="text"
						value="ShopRefundOrderNo12345" title="商城退款订单号"/></td>
				</tr>
			</table>
		</div>
		<div align="center"
